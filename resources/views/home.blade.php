...
@section('content')        
    <header class="inset-x-0 top-0 z-50 mx-auto px-4 sm:max-w-[576px] md:max-w-[768px] lg:max-w-[992px] xl:max-w-[1200px] 2xl:max-w-[1400px]">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="p-4">                
                ...
                <ul>
                    ...
                    <li><a href="#" class="text-gray-400 hover:underline">Termos de Serviço</a></li>                    
                </ul>
            </div>
            <div class="p-4">                
